 ...
 * Add icon set
 */
export declare const addCollection: (data: IconifyJSON, provider?: string | undefined) => boolean;
 ...
 * Calculate icon size
 */
export declare const calculateSize: (size: string | number, ratio: number, precision?: number | undefined) => string | number;
 ...
 * Get icon data
 */
export declare const getIcon: (name: string) => Required<IconifyIcon> | null;
 ...
 */
export declare const listIcons: (provider?: string | undefined, prefix?: string | undefined) => string[];

/**
 * Load icons
 */
export declare const loadIcons: (icons: (string | IconifyIconName)[], callback?: IconifyIconLoaderCallback | undefined) => IconifyIconLoaderAbort;
 ...
 */
export declare const replaceIDs: (body: string, prefix?: string | (() => string) | undefined) => string;
