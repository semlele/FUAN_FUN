...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 8, 2, 187);
    			add_location(div1, file$5, 9, 2, 238);
    			add_location(div2, file$5, 13, 2, 327);
    			add_location(div3, file$5, 14, 2, 378);
    			attr_dev(h1, "class", "app-title svelte-6stjch");
    			attr_dev(h1, "id", "top");
    			add_location(h1, file$5, 7, 1, 152);
    			attr_dev(button, "class", "getStart svelte-6stjch");
    			add_location(button, file$5, 19, 1, 481);
    			attr_dev(br0, "class", "space");
    			add_location(br0, file$5, 21, 2, 596);
    			attr_dev(h3, "class", "svelte-6stjch");
    			add_location(h3, file$5, 22, 2, 617);
    			attr_dev(h20, "class", "svelte-6stjch");
    			add_location(h20, file$5, 23, 2, 642);
    			add_location(br1, file$5, 24, 2, 669);
    			attr_dev(div4, "class", "explain svelte-6stjch");
    			add_location(div4, file$5, 25, 2, 676);
    			attr_dev(div5, "class", "explain svelte-6stjch");
    			add_location(div5, file$5, 26, 2, 750);
    ...
    const file$4 = "src/components/NoteEditor.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 19, 8, 570);
    			attr_dev(div0, "class", "button-container svelte-1mpd3iq");
    			add_location(div0, file$3, 18, 4, 531);
    			attr_dev(div1, "class", "add svelte-1mpd3iq");
    			add_location(div1, file$3, 16, 0, 379);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	let span0;
    	let t1;
    	let t2_value = /*note*/ ctx[1].title + "";
    	let t2;
    	let t3;
    	let div1;
    	let span1;
    	let t5;
    	let t6_value = /*note*/ ctx[1].jobName + "";
    	let t6;
    	let t7;
    	let div2;
    	let span2;
    	let t9;
    	let t10_value = /*note*/ ctx[1].contentFuan + "";
    	let t10;
    	let t11;
    	let div3;
    	let span3;
    	let t13;
    	let t14_value = /*note*/ ctx[1].contentWO + "";
    	let t14;
    	let t15;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*notes*/ 1 && t2_value !== (t2_value = /*note*/ ctx[1].title + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*notes*/ 1 && t6_value !== (t6_value = /*note*/ ctx[1].jobName + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*notes*/ 1 && t10_value !== (t10_value = /*note*/ ctx[1].contentFuan + "")) set_data_dev(t10, t10_value);
    			if (dirty & /*notes*/ 1 && t14_value !== (t14_value = /*note*/ ctx[1].contentWO + "")) set_data_dev(t14, t14_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "list_title svelte-1fw12ed");
    			add_location(h1, file$1, 8, 4, 195);
    			attr_dev(div, "class", "fuanlist svelte-1fw12ed");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Home, Add, FuanList, routes });
    	return [routes];
    }
