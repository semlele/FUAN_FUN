...
var app = (function () {
    ...
    const file$5 = "src/components/NoteList.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 8, 12, 217);
    			attr_dev(div1, "class", "card-content svelte-19edwrb");
    			add_location(div1, file$5, 9, 12, 272);
    			attr_dev(div2, "class", "card svelte-19edwrb");
    			add_location(div2, file$5, 7, 8, 146);
    		},
    		m: function mount(target, anchor) {
    ...
    class NoteList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { notes: 0 });
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Svelte Note";
    			t1 = space();
    			create_component(notelist.$$.fragment);
    			t2 = space();
    			button = element("button");
    			button.textContent = "+新しいノート";
    			attr_dev(h1, "class", "app-title svelte-11ojkc1");
    			add_location(h1, file$4, 9, 4, 225);
    			attr_dev(button, "class", "add svelte-11ojkc1");
    			add_location(button, file$4, 11, 4, 312);
    			attr_dev(div, "class", "home");
    			add_location(div, file$4, 8, 0, 202);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [userNotes, click_handler];
    }
    ...
    const file$3 = "src/components/NoteEditor.svelte";
    ...
    class NoteEditor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { title: 0, content: 1 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 17, 4, 432);
    			attr_dev(div0, "class", "button-container svelte-1asccat");
    			add_location(div0, file$2, 16, 4, 397);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "save svelte-1asccat");
    			button.disabled = button_disabled_value = !/*title*/ ctx[0] || !/*content*/ ctx[1];
    			add_location(button, file$1, 21, 4, 549);
    			attr_dev(div0, "class", "button-container svelte-1asccat");
    			add_location(div0, file$1, 20, 4, 514);
    			attr_dev(div1, "class", "add svelte-1asccat");
    			add_location(div1, file$1, 18, 0, 420);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
