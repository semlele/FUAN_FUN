...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "FUAN⇨FUN";
    			t1 = space();
    			div1 = element("div");
    			button1 = element("button");
    			button1.textContent = "ABOUT THIS SITE";
    			t3 = space();
    			button2 = element("button");
    			button2.textContent = "CONTACT";
    			t5 = space();
    			button3 = element("button");
    			button3.textContent = "CHECK FUAN!";
    			t7 = space();
    			main = element("main");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = () => push('/');
    	const click_handler_3 = () => push('/fuanlist');
    	...
    	return [routes, click_handler, click_handler_1, click_handler_2, click_handler_3];
    }
